...
export default function QuoteGen() {
    ...
    return (
        <div className='flex flex-col text-center text-xl text-white justify-center items-center my-4'>
            {/* <BlurryBg /> */}
            <div className='flex flex-col border-b break-words w-full md:w-1/2 border-gray-300 bg-gradient-to-b from-zinc-200 px-4 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30 hover:border-pink-600 hover:border-2'>

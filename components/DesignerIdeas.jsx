    ...
    return (
        <>
            <div className={` max-w-7xl mx-auto container lg:px-8 px-5 mt-10 text-white`}>
                ...
                >
                    <div className='flex flex-col gap-4'>
                        <label className='text-2xl font-semibold'>Got some new project idea to add to your designer list? <br />Add them here one by one.</label>
                        <input
                            type="text"
                            name=""
                            id=""
            ...
            <div className="max-w-7xl container lg:px-8 px-5 mx-auto my-4">
                <h3 className={`${montserrat.className} text-xl font-bold mb-2 text-white text-center`}>Your Ideas</h3>
            ...
            <h2 className={`${montserrat.className} text-3xl font-semibold text-center my-10`}>List of Design Ideas</h2>

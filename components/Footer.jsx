...
export default function Footer() {
  return (
    <footer className={`${opensans.className} bg-gray-950 py-5`}>
      <div className="container mx-auto sm:px-4 md:px-6 lg:px-8 max-w-[85rem]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-5">
          <Link
            href="/policy"
            className="font-medium hover:underline hover:underline-offset-4 lg:order-1 md:order-1 order-2"
          >
            Terms {"&"} Services
          </Link>
          ...
          <Link
            href="/contribute"
            className="font-medium hover:underline hover:underline-offset-4 order-3"
          >
            Contribute
          </Link>
        </div>

...
function TipsList(userId) {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <p className="text-xl font-bold mb-2 text-white">My Productivity Tips</p>
            {loader ? (
                <div role="status">
                ...
                <div>
                    {tipsList && tipsList.map(item => (
                        <div key={item.$id} >
                            <div className="p-4 flex items-center justify-between border-b border-gray-300 bg-gradient-to-b from-zinc-200 px-4 pb-6 pt-8 lg:backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:bg-zinc-800/30 gap-2 hover:shadow-lg hover:border-pink-500/40 my-4">
                                <div>

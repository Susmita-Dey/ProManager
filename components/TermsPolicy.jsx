                ...
                <div className='space-y-6'>
                    ...
                    <div>
                        <ul className='list-outside list-decimal space-y-4'>
                            ...
                            <li className='font-medium'>Intellectual Property</li>
                            <ol className='space-y-2 list-inside list-decimal'>
                            ...
                            <li className='font-medium'>Limitation of Liability</li>
                            <ol className='space-y-2 list-inside list-decimal'>
                            ...
                            <li className='font-medium'>Termination</li>
                            <ol className='space-y-2 list-inside list-decimal'>
                            ...
                            <li className='font-medium'>Changes to the Terms</li>
                            <ol className='space-y-2 list-inside list-decimal'>

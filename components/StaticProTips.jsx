        ...
        <div className='container max-w-[84rem] mx-auto lg:px-8 px-5 mt-10 mb-4'>
            ...
            <div className='flex flex-col flex-wrap text-center lg:flex-row text-lg gap-6 justify-center items-center'>
                {result.map((item, index) => (
                    <div key={index} className='flex flex-col border-2 gap-4 w-full lg:h-44 h-full border-gray-300 bg-gradient-to-b from-zinc-200 px-4 pb-6 pt-8 mb-5 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-96 lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30 hover:border-pink-600 hover:border-2'>

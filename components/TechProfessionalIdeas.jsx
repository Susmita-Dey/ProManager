...
function TechProfessionalIdeas(userId) {
            ...
            <div className="max-w-7xl mx-auto container lg:px-8 px-5 mt-10 text-white">
                ...
                >
                    <div className='flex flex-col gap-4'>
                        <label className='text-2xl font-semibold'>Got some new project idea to add to your Tech Professional list? Add them here one by one.</label>
                        <input
                            type="text"
                            name=""
                            id=""
...
export default TechProfessionalIdeas
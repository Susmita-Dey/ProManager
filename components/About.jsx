...
import { FaCreativeCommonsSamplingPlus, FaProjectDiagram, FaStopwatch, FaTasks } from 'react-icons/fa'
    ...
    return (
        <section className="min-h-full flex flex-col py-12 sm:px-6 lg:px-8" id='about'>
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center" data-aos="fade-up" data-aos-easing="linear"
                ...
                <div className="mx-auto mt-10 max-w-2xl sm:mt-16 lg:mt-20 lg:max-w-[84rem]" data-aos="flip-left" data-aos-easing="linear"
                    data-aos-duration="500">

...
export default function UseCaseComponent() {
    ...
    "For Students": [
      {
        ...
        subtitle:
          "ProManager empowers students to excel academically and stay organized amidst their busy schedules.",
    ...
    "For Teachers": [
      {
        ...
        subtitle:
          "ProManager supports teachers in organizing tasks, managing resources, and facilitating student engagement.",
    ...
    "For Developers": [
      {
        ...
        subtitle:
          "ProManager empowers developers to streamline workflows, track tasks, and achieve coding excellence",
    ...
    "For Individuals": [
      {
        ...
        subtitle:
          "ProManager helps individuals stay organized, achieve goals, and maximize their productivity potential.",
  ...
  return (
    <section
      className="container mx-auto md:px-16 py-12 lg:mt-32 sm:px-6 lg:px-8"
      id="use-case"
    >
      <div className="flex flex-col justify-center items-center gap-5">
        <h2
          className={`${montserrat.className} text-3xl font-semibold`}
          data-aos="fade-up"
          data-aos-easing="linear"
          data-aos-duration="500"
        >
          Real-Life
          <span className="ml-2 text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            Applications
          </span>
        </h2>
        <p
          ...
          data-aos-duration="500"
        >
          Explore how ProManager benefits developers, students, and individuals
          <br /> in various scenarios to achieve their goals efficiently.
        </p>
        <div
          className="w-full max-w-[84rem] min-h-full px-2 py-16 sm:px-0 justify-center items-center"
          data-aos="zoom-in"
          data-aos-easing="linear"
          data-aos-duration="500"
        >
                ...
                <Tab
                  ...
                  className={({ selected }) =>
                    classNames(
                      ...
                      selected
                        ? "bg-gray-300 shadow text-pink-700"
